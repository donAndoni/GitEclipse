 ...
 * Primeramente declaramos las variables que utilizaremos en el programa
 * @author Andoni Arrillaga
 *
 */
public class notas {
	...
	/**
	 * Con este método calculamos la nota definitiva del estudiante
	 */
	...
	/**
	 * Con este método mostramos todos los datos introducidos
	 */
	public void Mostrar() {
	...
	/**
	 * Con este método mostraremos por pantalla si el estudiante ha aprobado o no
	 */
	...
	/**
	 * Éste es el método principal, donde llamamos a todas las funciones
	 * 
	 * @param args
	 */
